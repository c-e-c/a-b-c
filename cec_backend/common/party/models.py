...
# from common.system.models import BizParamValue


class PartyType(GeneralBaseModel):
    """
        当事人类型
    """

    code = models.CharField(max_length=256, blank=True, null=True, verbose_name="编号")
    name = models.CharField(max_length=256, blank=True, null=True, verbose_name="名称")
